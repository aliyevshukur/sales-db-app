...
function Home() {
  ...
  } = useStretchLetterSpacing(subtitleText);
      ...
      <div className='home'>
        <div className='home-hero'>
          <div
            ...
            style={{ letterSpacing: `${subtitleLetterSpacing}px` }}
          >
            <div
              className='home-hero-text-upper-subtitle'
              ref={subtitleTextRef}
            >
              {subtitleText}
            </div>
            <div className='home-hero-text-title'>SPEAKERS</div>
            <div className='home-hero-text-subtitle'>
              Discover premium speakers that bring your music to life.
            </div>
            <ShopButton />
          </div>
